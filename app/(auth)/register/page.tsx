      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden">
        ...
        <div className="px-7 pb-7 space-y-5">
          ...
          {step === "otp" && (
            <>
              {/* Summary chip */}
              <div className="flex items-center gap-2 bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 rounded-xl px-4 py-2.5">
                  ...
                  {otp.map((digit, i) => (
                    <input
                      ...
                      className={`w-11 h-12 text-center text-lg font-bold border rounded-xl outline-none transition-all ${
                        digit
                          ? "border-accent-500 bg-orange-50 dark:bg-orange-900/20 text-accent-700 dark:text-accent-400"
                          : "border-gray-200 dark:border-gray-600 text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-700"
                      } focus:border-accent-500 focus:ring-2 focus:ring-orange-100 dark:focus:ring-orange-900/30`}
                    />
                  ))}
                </div>
              </div>
